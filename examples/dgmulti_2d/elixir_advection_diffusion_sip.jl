...
# Use Symmetric Interior Penalty (SIP) method for parabolic terms
# The penalty parameter alpha controls the strength of the penalty term.
# Typical values are between 1 and 10. Higher values increase stability
# but also increase dissipation.
solver_parabolic = ViscousFormulationSIP(5.0)
